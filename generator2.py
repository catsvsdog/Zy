...
#     top2 = Top("bm",{ "blue"}, {"summer"}, "tight", "3IMG_1479")
#     bot1 = Bottom("chuu", {"gray"}, {"summer", "fall"}, "baggy", "1IMG_1475")
#     bot2 = Bottom("jean", {"lightBlue"}, {"summer"}, "tight", "2IMG_1476")
#     app.tops = [top1, top2]
...
#             app.likedOutfits.add(app.final[i])
